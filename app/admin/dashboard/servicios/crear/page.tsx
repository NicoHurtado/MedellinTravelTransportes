...
export default function CrearServicioPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!nombreES || !nombreEN) {
            alert('Por favor completa el Nombre del Servicio en ambos idiomas (Español e Inglés)');
            return;
        }
        ...
        if (!descripcionES || !descripcionEN) {
            alert('Por favor completa la Descripción en ambos idiomas (Español e Inglés)');
            return;
        }
    ...
    return (
        <div className="p-6 max-w-5xl mx-auto">
            ...
            <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                    <h1 className="text-3xl font-bold text-gray-900">Crear Servicio</h1>
                    <p className="text-gray-600 mt-1">
                        Configura un nuevo servicio con campos dinámicos
                    </p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            >
                                ...
                                <option value="TRANSPORTE_POR_HORAS">Transporte por Horas</option>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500">
                                    Muestra botones especiales para &quot;Hacia/Desde Aeropuerto&quot; y selección de aeropuerto (JMC/Olaya Herrera)
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                            <input
                                ...
                                id="esPorHoras"
                                checked={esPorHoras}
                                onChange={(e) => setEsPorHoras(e.target.checked)}
                                className="mt-1 w-4 h-4 text-[#D6A75D] border-gray-300 rounded focus:ring-[#D6A75D]"
                            />
                            <div>
                                <label htmlFor="esPorHoras" className="font-medium cursor-pointer">
                                    Este es un servicio por horas
                                </label>
                                <p className="text-sm text-gray-500">
                                    Habilita la selección de horas y oculta campos de dirección/municipio en el wizard
                                </p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            />
                            <p className="text-sm text-gray-500 mt-1">
                                Si se configura, el campo &quot;Destino&quot; se llenará automáticamente con este valor
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <p className="text-gray-600 mb-4">
                        Selecciona los vehículos disponibles para este servicio y configura el precio para cada uno
                    </p>

                    {vehiculos.length === 0 ? (
                        <div className="text-center py-8 text-gray-500">
                            No hay vehículos registrados. Crea vehículos primero.
                        </div>
                    ) : (
